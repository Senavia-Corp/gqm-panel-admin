  ...
  return createPortal(
    <>
      ...
      >
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between border-b border-slate-100 px-4 pt-4 pb-3 flex-shrink-0 bg-slate-50/50 sm:px-6 sm:pt-5 sm:pb-4">
          ...
          <div className="flex-1 min-h-0 flex flex-col lg:flex-row overflow-hidden">
            ...
            {/* Left panel */}
            <div className="max-h-[45%] overflow-y-auto lg:max-h-none lg:w-80 border-b lg:border-b-0 lg:border-r border-slate-100 bg-white px-4 py-4 flex flex-col gap-5 sm:px-6 sm:py-5 sm:gap-6">
          ...
          {/* Footer */}
          <div className="flex flex-wrap items-center justify-end gap-3 border-t border-slate-100 bg-slate-50/50 px-4 py-3.5 flex-shrink-0 sm:px-6 sm:py-4">
            <button 
              type="button" 
              onClick={() => !isSubmitting && onOpenChange(false)} 
              disabled={isSubmitting}
