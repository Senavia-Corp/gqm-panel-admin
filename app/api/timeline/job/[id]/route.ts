// app/api/timeline/job/[id]/route.ts
...
export async function GET(
  ...
  // Forward pagination params: ?page=1&limit=20
  ...
  const url = `${PYTHON_BASE_URL.replace(/\/$/, "")}/tlactivity/job/${encodeURIComponent(idJob)}${qs ? `?${qs}` : ""}`
  console.log("[timeline proxy] GET by ID_Jobs ->", url)
