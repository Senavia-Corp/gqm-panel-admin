...
function ItemRow({
  ...
  return (
    <div className="group flex items-start gap-3 rounded-xl border border-slate-100 bg-white px-4 py-3 hover:border-slate-200 hover:shadow-sm transition-all">
      ...
      <div className="min-w-0 flex-1 grid grid-cols-1 gap-y-3 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-1">
        <div className="sm:col-span-2">
...
function OrderBlock({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      {/* Order header */}
      <div className="flex items-center gap-3 border-b border-slate-100 bg-slate-50/60 px-4 py-3 sm:px-5 sm:py-3.5">
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          ...
          <main className="flex-1 overflow-x-hidden overflow-y-auto">
            ...
            <div className="border-b border-slate-200 bg-white px-4 py-4 sm:px-6 sm:py-5">
              <div className="flex items-center justify-between gap-3">
                <div className="flex min-w-0 items-center gap-2.5 sm:gap-3">
                  ...
                  <div className="hidden h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl bg-emerald-50 sm:flex">
                    <ShoppingCart className="h-4.5 w-4.5 text-emerald-600" />
                  </div>
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      <h1 className="truncate font-mono text-base font-bold text-slate-900 sm:text-lg">{purchase.ID_Purchase ?? id}</h1>
            ...
            <div className="p-4 sm:p-6">
              <div className="grid gap-5 sm:gap-6 xl:grid-cols-[1fr_420px]">
